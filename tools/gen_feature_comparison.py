...
SUPPORTED_FEATURES = {
    ...
    "ExecStart": {"icon": ICON_TICK, "text": "Exec'ing the command given is supported. The return value is checked for oneshot services. Ignoring the return value is not yet supported."},
    "ExecStartPre": {"icon": ICON_QMARK,  "text": "Allowing commands to be run is supported. The return value is checked. Ignoring the return value is not yet supported."},
    "ExecStartPost": {"icon": ICON_QMARK, "text": "Allowing commands to be run is supported. The return value is checked. Ignoring the return value is not yet supported."},
    "ExecStop": {"icon": ICON_QMARK,      "text": "Allowing commands to be run is supported. The return value is checked. Ignoring the return value is not yet supported."},
    "ExecStopPost": {"icon": ICON_QMARK,  "text": "Allowing commands to be run is supported. The return value is checked. Ignoring the return value is not yet supported."},
